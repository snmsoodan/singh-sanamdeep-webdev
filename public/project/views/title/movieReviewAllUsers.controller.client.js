(function() {
    angular
        .module("WebAppMaker")
        .controller("MovieAllReviewController", MovieAllReviewController);

    // function MovieHomeController($location, YelpService, $routeParams, UserService, LikeService,ReviewService, CategoryService) {
    function MovieAllReviewController($location, MovieService, $routeParams, LikeService,UserService,ReviewService) {
        var vm = this;
